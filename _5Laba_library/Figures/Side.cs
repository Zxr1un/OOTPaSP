...
namespace _5Laba_library
{
    ...
    public class Side: PolygonMy, ISide
    {
        ...
        public override IFigureMy Clone(IFigureMy part = null, IFigureMy parentCop = null)
        {
            ...
            {
                clone = new(FFref, SEref, WF, polClone, new(glob.X, glob.Y), new(glob_2.X, glob_2.Y));
        ...
        public Side(IFigureFactory fFref, ISE ser, IWindowsFactory wf, IPolygonMy par,Point p1, Point p2) : base(fFref, ser, wf)
        {
            poly.Points.Clear();
            for(int i = 0; i < 4; i++)
            {
        ...
        public void UpdatePoints(Point p1, Point p2, ISide prev = null, ISide next = null)
        {
            glob = p1;
            glob_2 = p2;
        ...
        public void Calculate_Connection(ISide prev = null, ISide next = null)
        {
        ...
        {
            glob_2 = FFref.GetPoint(el, "glob_2");
            if (el.TryGetProperty("thickness", out var th)) thickness = (int)th.GetDouble();
            string color = FFref.GetString(el, "color_s");
        ...
        public override void Save(IFigureMy fig, Dictionary<string, object> dict)
        {
            ...
            dict["color_s"] = FFref.BrushToString(color_s);
        }
